      ...
      <Container className="mb-2">
        ...
        <Row>
          <h4 className="text-center">
            Services at <span className="hotel-color">Black Hotel</span>
          ...
          <Col>
            <Card>
              <Card.Body>
                ...
                <Card.Text>Star your day with a delicious breakfast buffect.</Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col>
            <Card>
              <Card.Body>
                ...
                <Card.Text>Keep your clothes clean and fresh with out laundry service.</Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col>
